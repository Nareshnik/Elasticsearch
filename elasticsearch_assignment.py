...
# Replace 'your_password' with the actual password set during installation
es = Elasticsearch(
    ["http://localhost:9200"],
    basic_auth=('elastic', '9nAn611NiIaCL627AGDK'),  # Add your username and password here
    verify_certs=False  # Optional: Disable SSL verification (not recommended for production)
)
...
es = Elasticsearch(
    ["http://localhost:9200"],
    basic_auth=('elastic', '9nAn611NiIaCL627AGDK'),
    verify_certs=False
)
